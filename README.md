...
La caméra utilise une perspective douce de 28°, centrée face au plateau, avec une inclinaison initiale de 58°. La molette rapproche la caméra jusqu'au gros plan ; le clic molette déplace la vue et `C` réinitialise le cadrage. Le plateau repose sur une table en bois avec veinage procédural, finition mate des cases et ombre de contact diffuse sous le socle.
...
Les cases, marqueurs, reflets stylisés des lacs et ombres de contact sont dessinés dans raylib. Les matériaux reçoivent un éclairage directionnel GLSL. Le plateau conserve son bois sombre et ses incrustations de laiton. Les pièces reprennent le style classique du jeu de plateau : plastique bleu/rouge, socle rectangulaire, créneaux et plaque argent/or portant un profil militaire et son rang sur une seule face. Les dessins sont reconstruits, pas copiés pixel pour pixel. Les références photographiques sont documentées dans `assets/references/README.md`.
...
L'ordinateur alterne six familles de placement originales, avec variantes miroir et permutations internes : coin fortifié, abri derrière un lac, centre protégé, aile protégée, deuxième ligne et défense mobile avec leurres. Un sac mélangé évite de répéter la même famille avant d'avoir parcouru les six ; la dernière famille est conservée pour éviter sa répétition immédiate au redémarrage. Les trois voies disposent de démineurs et d'officiers d'appui, avec un espion adjacent au maréchal. Voir [la recherche et les contraintes de placement](tests/DEPLOYMENT_RESEARCH.md). Le joueur conserve son placement libre. Le calcul se fait en arrière-plan ; quatre branches indépendantes peuvent être évaluées simultanément sans changer le résultat déterministe à graine identique.
