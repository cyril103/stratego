...
Les cases, marqueurs et ombres de contact sont dessinés dans raylib. Le terrain, le bois, les rives et l'eau disposent de matériaux GLSL distincts ; les reflets de l'eau sont procéduraux. Le quadrillage reste discret et les huit cases des lacs restent infranchissables, y compris leurs berges décoratives. Les pièces reprennent le style classique du jeu de plateau : plastique bleu/rouge, socle rectangulaire, créneaux et plaque argent/or portant un profil militaire et son rang sur une seule face. Les dessins sont reconstruits, pas copiés pixel pour pixel. Les références photographiques sont documentées dans `assets/references/README.md`.
